...
var app = (function () {
    ...
    /* src\Output.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1rt6sxj");
    			toggle_class(h1, "red", /*courseGoal*/ ctx[0].includes("!"));
    			add_location(h1, file$1, 5, 0, 53);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 5, 0, 83);
    			add_location(p, file, 7, 0, 104);
    			add_location(li0, file, 10, 2, 138);
    			add_location(li1, file, 11, 2, 210);
    			add_location(li2, file, 12, 2, 256);
    			add_location(li3, file, 16, 2, 371);
    			add_location(ol, file, 9, 0, 131);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 22, 0, 482);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
